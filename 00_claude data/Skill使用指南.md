...
| **dashboard-qc** | 開儀表板、查看儀表板、品管儀表板 | 15 品管儀表板查看與更新 | ⭐⭐⭐ |
| **download-checker** | 檢查下載、檢查週報、檢查月報 | 02 下載監控與待處理管理 | ⭐⭐⭐ |
| **fabric-inspection-system** | 啟動驗布系統、記錄驗布、發送驗報 | 24 布料檢驗 FastAPI Web 應用 | ⭐⭐ |
| **thumbnail-html-embed** | 嵌入縮圖、HTML 縮圖、響應式縮圖 | 通用 — HTML 縮圖技術指南 | ⭐ |
| **qc-expense-management** | 整理出差費、QC 報銷、差旅費管理 | 21 + 22 QC 費用與報銷管理 | ⭐⭐ |
